...
const handleSubmit = () => {
    console.log({ password: password.value, passwordConfirmation: passwordConfirmation.value });
};
</script>
        ...
        <main class="auth-page">
            <div class="auth-card">
                <div class="auth-illustration">
                    ...
                    <p>Set a strong password to keep your account secure and regain access instantly.</p>

                    <ul>
                        <li>Protect your account from unauthorized access</li>
                        <li>Use a unique password for better security</li>
                        <li>Continue shopping with confidence</li>
                    </ul>
                </div>
                ...
                <div class="auth-form-panel">
                    <div class="form-top">
                        ...
                        <p class="helper-text"><Link href="/login">Back to login</Link></p>
                    </div>

                    <h2>Reset password</h2>
                    <p class="form-intro">Enter your new password below.</p>
                    ...
                    <form class="auth-form" @submit.prevent="handleSubmit">
                        ...
                        <label>
                            ...
                            <input v-model="passwordConfirmation" type="password" placeholder="Re-enter new password" required />
                        </label>
