...
class DashboardDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $ordersData = [
            ['grand_total' => 18999.00, 'status' => 'completed', 'created_at' => now()->subDays(5)],
            ['grand_total' => 4599.00, 'status' => 'completed', 'created_at' => now()->subDays(4)],
            ['grand_total' => 12499.00, 'status' => 'processing', 'created_at' => now()->subDays(3)],
            ['grand_total' => 799.00, 'status' => 'pending', 'created_at' => now()->subDays(2)],
            ['grand_total' => 3499.00, 'status' => 'cancelled', 'created_at' => now()->subDays(1)],
            ['grand_total' => 23998.00, 'status' => 'completed', 'created_at' => now()->subHours(12)],
            ['grand_total' => 5999.00, 'status' => 'pending', 'created_at' => now()->subHours(6)],
            ['grand_total' => 1299.00, 'status' => 'completed', 'created_at' => now()->subHours(2)],
        ];
